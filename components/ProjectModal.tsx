...
const ProjectModal = () => {
    return ( 
        <div id="projects" className="dark:bg-slate-900 bg-amber-400 w-auto h-auto flex flex-col p-2 my-2 mx-0 lg:mx-20 justify-between items-center border-[1px] border-white ">
